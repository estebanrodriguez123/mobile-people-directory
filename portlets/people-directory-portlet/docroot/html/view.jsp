...
<div id="people-directory-container">
	...
	<%
		...
		String tabNames = "Search,View All";
		String tabVals = "search,view";
	...
	<liferay-ui:tabs names="<%=tabNames%>" tabsValues="<%=tabVals%>"
		...
		<liferay-ui:search-container delta="<%=recordCount %>"
			...
			<liferay-ui:search-container-row indexVar="indexer"
				...
				<%
					...
					profileURL.setParameter(PeopleDirectoryPortlet.PARAMETER_KEYWORDS, String.valueOf(user.getUserId()));
